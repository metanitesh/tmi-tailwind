        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-indigo-600">
              Based on The mind illuminated and Samatha tradition
            </h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Cultivate meditation practice
            </p>
...
//             Cultivate meditation practice systematically through Nine Stages
//           </h1>
//           <h2 className="text-xl py-6 ">
//             Based on The Mind Illuminated and Samatha tradition.
//           </h2>
//           <Link className="btn btn-primary" href={"/stage1"}>
//             Stage1
//           </Link>
//         </div>
//       </div>
...
//     // <h1 className="text-3xl text-center font-black mx-40 font-inter">
//     //   Cultivate meditation practice systematically through Nine Stages
//     // </h1>
//     // <h2 className="text-xl text-center font-black mx-40 font-inter">based on The Mind Illuminated and Samatha tradition.</h2>
